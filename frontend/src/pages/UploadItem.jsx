    ...
    >
      <div className="mb-8 flex justify-center space-x-4">
        <button
          ...
          className={`px-8 py-3 rounded-lg font-bold transition-all duration-300 ${type === 'found'
        ...
        <button
          ...
          className={`px-8 py-3 rounded-lg font-bold transition-all duration-300 ${type === 'lost'
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end pt-4 border-t border-white/10">
            <button
              type="submit"
              disabled={isLoading}
              className={`flex items-center gap-2 px-8 py-3 rounded-lg font-bold transition-all duration-300 ${type === 'found'
